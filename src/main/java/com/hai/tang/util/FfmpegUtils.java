...
public class FfmpegUtils {
    ...
    private static String  ffmpegNoInstallTip= "";
    ...
    static {
        ...
        File ffplaFile = new File(ffplay);
        File ffmpegFile = new File(ffmpeg);
        File ffprobeFile = new File(ffprobe);
        if(!ffplaFile.exists()||!ffmpegFile.exists()||!ffprobeFile.exists()){
            ffmpegNoInstallTip = "请检查 ffmpeg是否安装，未找到 ffplay.exe、ffmpeg.exe、ffprobe.exe";
            System.out.println(ffmpegNoInstallTip);
        }
    }
