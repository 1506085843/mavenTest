...
public class DiffHandleUtils {
    ...
    //将resource下的css和js文件复制到 jsCssPath 目录下
    public static void copyfile(String jsCssPath) {
        try {
            InputStream inputStream1 = DiffHandleUtils.class.getClassLoader().getResourceAsStream("jscss/diff2html.min.css");
            FileUtils.copyInputStreamToFile(inputStream1, new File(jsCssPath + "diff2html.min.css"));

            InputStream inputStream2 = DiffHandleUtils.class.getClassLoader().getResourceAsStream("jscss/diff2html-ui.min.js");
