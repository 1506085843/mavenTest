...
public class TrieTreeTest {
    ...
    public void trieTree() {
        ...
        String[] array = new String[]{"张三的歌","张三的曲","我爱你", "张三", "张力", "张五", "张留的歌", "张留", "李四付出", "李四的歌", "张四的歌啊", "李四的歌啊", "qqq", "李四", "李四", "张五是到", "李四的改"};
        t.add(array);
        //t.clearRootNode();
        ...
        System.out.println(t.haveWord("张三"));
        System.out.println(t.startWordWith("张三的"));
        t.deleteWord("我爱你");//完全删除
        System.out.println(t.getRootNode());
        t.deleteWord("张三的曲");
        System.out.println(t.getRootNode());
        ...
        System.out.println(t.sensitiveWordReplace(text));
        System.out.println();
