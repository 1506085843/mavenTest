...
public class TrieTreeTest {
    ...
    public void trieTree() {
        ...
        String[] array=new String[]{"张三","张五","张留的歌","张三的歌","李四付出","李四的歌","张四的歌啊","李四的歌啊","qqq","李四","李四","张五是到","李四的改"};
       ...
       // System.out.println(t.getRootNode());
         ...
         String text="接着判断张留的歌指针2和指针3张留的张五李四的歌啊之间的字张四的歌啊符是否属于敏感词，假设指针2指向x，由于Root的子节点不存在x，\n"+
